...
import com.demo.resetmysoul.study_demo.domain.BaseInfo;
...
public class ChapterAdapter extends Adapter implements View.OnClickListener  {
        ...
        if(getItemViewType(position) == VIEW_TYPE_CHAPTER){
            ...
            if(chapterInfo.sectionInfos.size() > 0){
                ...
                if(curExpandChapterIndex == position){
                    itemHolder.ivArrow.setBackgroundResource(R.drawable.arrow_up_grey);
                }else{
                    itemHolder.ivArrow.setBackgroundResource(R.drawable.arrow_bottom_grey);
                }
            }else{
